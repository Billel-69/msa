...
import {
  ...
  FaRegLightbulb, FaArrowRight, FaCheckCircle, FaAward
} from 'react-icons/fa';
import './MiniGamesRefinedEnhanced.css';
                    ...
                    <div className="minigames-achievements">
                        ...
                        <div className="achievements-grid">
                            <div className="achievement-item bronze">
                                ...
                                <span className="achievement-title">Première Victoire</span>
                            ...
                            <div className="achievement-item silver">
                                <span className="achievement-badge">🥈</span>
                                <span className="achievement-title">Maître des Sessions</span>
                                <div className="achievement-progress">
                                    <div className="progress-bar">
                                        <div className="progress-fill" style={{width: '0%'}}></div>
                                    </div>
